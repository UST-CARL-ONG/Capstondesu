...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="SWDBAnnouncements.jsp">Organissembly</a>
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-7 col-sm-12 col-12">
                        ...
                        <div class="influence-profile-content pills-regular">
                            <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-campaign-tab" data-toggle="pill" href="#pills-campaign" role="tab" aria-controls="pills-campaign" aria-selected="true">Announcements</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="pills-msg-tab" data-toggle="pill" href="#pills-msg" role="tab" aria-controls="pills-msg" aria-selected="false">Add an Announcement</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                        ...
                                                        <div class="media-body ">
                                                            <div class="influencer-profile-data">
                                                                <h3 class="m-b-10">Announcement</h3>
                                                                <p>
                                                                        <span class="m-r-20 d-inline-block">Date Announced
                                                                            <span class="m-l-10 text-primary">24 December 2019</span>
                                                                        </span>
                                                                    <span class="m-r-20 d-inline-block"> Announcement Expiration
                                                                            <span class="m-l-10 text-secondary">30 Feb 2020</span>
                                                                        </span>
                                                                    <span class="m-r-20 d-inline-block">Ends <span class="m-l-10  text-info">30 May, 2020</span>
                                                                        </span>
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                        ...
                                                        <div class="media-body">
                                                            <h3 class="m-b-10">Announcement1</h3>
                                                            <p><span class="m-r-20 d-inline-block">Date Announced<span class="m-l-10 d-inline-block text-primary">28 December 2019</span></span><span class="m-r-20 d-inline-block"> Announcement Expiration<span class="m-l-10 text-secondary">20 March 2020</span></span><span class="m-r-20">Ends<span class="m-l-10 text-info">10 July, 2020</span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                        ...
                                                        <div class="media-body">
                                                            <h3 class="m-b-10">Announcement2</h3>
                                                            <p><span class="m-r-20 d-inline-block">Date Announced
                                                                    <span class="m-l-10 text-primary">05 Feb 2020</span></span>
                                                                <span class="m-r-20 d-inline-block"> Announcement Expiration
                                                                        <span class="m-l-10 text-secondary">14 May 2020</span></span><span class="m-r-20 d-inline-block">Ends<span class="m-l-10 text-info">16 Aug, 2020</span></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="pills-msg" role="tabpanel" aria-labelledby="pills-msg-tab">
                                    <div class="card">
                                        <h5 class="card-header">Add Announcement</h5>
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="offset-xl-3 col-xl-6 offset-lg-3 col-lg-3 col-md-12 col-sm-12 col-12 p-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="messages">Announcement Details</label>
                                                            <textarea class="form-control" id="messages" rows="3"></textarea>
                                                        </div>
                                                        <button type="submit" class="btn btn-primary float-right">Add Announcement</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
