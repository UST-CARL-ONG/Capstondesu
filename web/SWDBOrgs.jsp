    ...
    <div class="dashboard-main-wrapper">
	    ...
	    <div class="dashboard-header">
	        <nav class="navbar navbar-expand-lg bg-white fixed-top">
	            <a class="navbar-brand" href="index.html">Organissembly</a>
	                    ...
	                    <li class="nav-item dropdown nav-user">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
	                            <div class="nav-user-info">
	                                <h5 class="mb-0 text-white nav-user-name">Caral Ong </h5>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            ...
	                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                <div class="card campaign-card text-center">
	                                    <div class="card-body">
	                                        <div class="campaign-img"><img src="imahe/comelec.jpg" alt="user" class=" user-avatar-xl"></div>
	                                            <div class="campaign-info">
	                                                <h3 class="mb-1">ROTARACT</h3>
	                                                <p class="mb-3">I don't even know what dis org does</p>
	                                                <p class="mb-1">Members: <span class="text-dark font-medium ml-2">30</span></p>
	                                                <p>Officers: <span class="text-dark font-medium ml-2">13</span></p>
													<a href="#" class="btn btn-secondary">Enable/Disable</a>
	                                ...
	                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                    <div class="card campaign-card text-center">
	                                        <div class="card-body">
	                                            <div class="campaign-img"><img src="imahe/council.png" alt="user" class="user-avatar-xl"></div>
	                                                <div class="campaign-info">
	                                                    <h3 class="mb-1">Student Council</h3>
	                                                    <p class="mb-3">Guardians of the ust.</p>
	                                                    <p class="mb-1">Members<span class="text-dark font-medium ml-2">0</span></p>
	                                                    <p>Officers: <span class="text-dark font-medium ml-2">Dead</span></p>
														<a href="#" class="btn btn-secondary">Enable/Disable</a>
	                                    ...
	                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                        <div class="card campaign-card text-center">
	                                            <div class="card-body">
	                                                <div class="campaign-img"><img src="imahe/jpcs.jpg" alt="user" class="user-avatar-xl"></div>
	                                                    <div class="campaign-info">
	                                                        <h3 class="mb-1">JPCS</h3>
	                                                        <p class="mb-3">weebs </p>
	                                                        <p class="mb-1">Members<span class="text-dark font-medium ml-2">4,50,000</span></p>
	                                                        <p>Officers: <span class="text-dark font-medium ml-2">47</span></p>
															<a href="#" class="btn btn-secondary">Enable/Disable</a>
